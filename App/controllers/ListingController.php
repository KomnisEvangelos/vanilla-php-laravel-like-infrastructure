...
class ListingController
{
    ...
    public function store()
    {
        ...
        if (!empty($erros)) {
            ...
            $this->database->query($query, $newListingData);
    ...
    public function destroy($params)
    {
        ...
        $this->database->query('DELETE FROM listings WHERE id = :id', $params);
        redirect('/listings');
    }
    ...
    public function update($params)
    {
        ...
        if (!empty($errors)) {
            ...
            $updateValues['id'] = $id;
            $this->database->query($updateQuery, $updateValues);
    ...
    public function search()
    {
        ...
        $listings = $this->database->query($query, $params)->fetchAll();
